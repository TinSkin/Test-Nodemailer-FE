...
// If mode is in development environment (development), API_URL will be "http://localhost:5000/api/users"
// If mode is in production environment (production), API_URL will be "https://test-nodemailer-be.onrender.com/api/users"
const API_URL = import.meta.env.MODE === "development" ? "http://localhost:5000/api/users" : "https://test-nodemailer-be.onrender.com/api/users";
